...
#table original
#drive_download("~/Watters and Kruger rebuttal/Watters #sensitivities/hr_derived_s_original.csv",
#               overwrite=TRUE)
d.org = read_csv("hr_derived_s_original.csv",col_types="dddfd")
#table 37a
#drive_download("~/Watters and Kruger rebuttal/Watters sensitivities/hr_derived_s_37.csv",
#               overwrite=TRUE)
d37a = read_csv("hr_derived_s_37.csv",col_types="dddfd")
#table 37b
#drive_download("~/Watters and Kruger rebuttal/Watters #sensitivities/hr_derived_s_37b.csv",
#               overwrite=TRUE)
d37b = read_csv("hr_derived_s_37b.csv",col_types="dddfd")
#table 38
#drive_download("~/Watters and Kruger rebuttal/Watters sensitivities/hr_derived_s_38.csv",
#               overwrite=TRUE)
#d38 = read_csv("hr_derived_s_38.csv",col_types="dddfd")
#table 39
#drive_download("~/Watters and Kruger rebuttal/Watters sensitivities/hr_derived_s_39.csv",
#               overwrite=TRUE)
#d39 = read_csv("hr_derived_s_39.csv",col_types="dddfd")
#table 40
#drive_download("~/Watters and Kruger rebuttal/Watters sensitivities/hr_derived_s_40.csv",
#               overwrite=TRUE)
#d40 = read_csv("hr_derived_s_40.csv",col_types="dddfd")
#table 41
#drive_download("~/Watters and Kruger rebuttal/Watters sensitivities/hr_derived_s_41.csv",
#               overwrite=TRUE)
