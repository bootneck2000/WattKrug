...
\midrule
Does intervention X improve outcome Y? & Dataset1.csv & Yes; t = 2.45, p = 0.018 & Appendix A, Code Chunk 3\\
Is variable A associated with variable B? & SurveyData2024.xlsx & No; r = 0.05, p = 0.670 & Appendix B, Section 2\\
