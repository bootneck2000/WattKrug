...
al. (2020). Statistical results from the nonparametric one-way Kruskal-Wallis test are
...
knitr::kable(table.original.scenario, booktabs=TRUE,  col.names = c("Effects", 
             ...
             longtable=TRUE, align="lccccc", caption = "Table 2. Original table in Watters et al. 2020.  In this and all subsequent tables below, posterior and posterior predictive probabilities that expected performance given the effects indicated in the left-most column are less than the expected performance given effects or conditions indicated in the column headings. Posterior predictive probabilities are indicated in parentheses. ONI is the Oceanic Niño Index, LKB is local krill biomass, and LHR is local harvest rate. Worst Case is represented by neutral ONI; LHR  $\\geqslant$ 0.1; and LKB $\\geqslant$ 1Mt.  The Best Case is represented by La Niña conditions, low LKB and low LHR.", escape=FALSE)
...
knitr::kable(table.original.scenario, booktabs=TRUE,  col.names = c("Effects", 
             ...
             "Long-term µ", 
              "Long-term predicted µ"),
             longtable=TRUE, align="lccccc", caption = "Table 3. Posterior and posterior predictive probabilities for Spatial Model (Andy 1).", escape=FALSE)
...
```{r Table 4 Posterior and posterior predictive probabilities, warning=FALSE, echo=FALSE}
### Replica of Summary Table 1, Watters et al. ----
keepers = c(37:74)
pt = d.SSMUs %>%
  dplyr::group_by(Parameter) %>%
...
knitr::kable(table.original.scenario, booktabs=TRUE,  col.names = c("Effects", 
             ...
             "Long-term µ", 
              "Long-term predicted µ"),
             longtable=TRUE, align="lccccc", caption = "Table 4. Posterior and posterior predictive probabilities for Spatial Model by SSMUs.", escape=FALSE) 
