...
knitr::kable(table.original.scenario, booktabs=TRUE,  col.names = c("Effects", 
             ...
             "Long-term mean", 
              "Predicted long-term mean"),
             longtable=TRUE, align="lccccc", caption = "Table 3. Posterior (long-term mean) and posterior predictive (predicted long-term mean) probabilities for Model SSMU.", escape=FALSE)
