...
Table 1: Estimations of mean and sd of Ln(LKB), as per Equation (2) (Watters et al. 2020), and xx test between -/+ SAM values within each gSSMU. THe equivalent LKB value is given in 'mean LKB'.   
...
Figure 1. Location of the penguin colonies (COPA: red dot; SHIRREF: blue dot), gSSMU #1 (blue dashed area) and #2 (red dashed area), and SSMUs (APEI: Antarctic Peninsula Elephant Island; APDPE: Antarctic Peninsula Drake Passage East; APDPW: Antarctic Peninsula Drake Passage West; APBSE: Antarctic Peninsula Bransfield Strait East; APBSW: Antarctic Peninsula Bransfield Strait West). 
...
Figure 2. Krill survey estimates (LKB) for the study period. Top: gSSMU #2 (SSIW-EI); Bottom: gSSMU #1 (BS). Filled circles: Survey data from Watters et al. (2020); Open circles: mean imputed median LKB-value for -/+ SAM; filled triangles: survey data from Wang et al. (2025). 
