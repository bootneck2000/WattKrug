...
\newpage
```{r fig-s2, fig.show="hold", out.width="55%", echo=FALSE}

knitr::include_graphics(c(
  "./A_Results/Watters_model/Imputed/freq_dist_summer_biomass.png",
  "./A_Results/Watters_model/Imputed/freq_dist_summer_hr.png"))
knitr::include_graphics(c(
  "./A_Results/Watters_model/Imputed/obs_freq_dist_summer_biomass.png",
  "./A_Results/Watters_model/Imputed/obs_freq_dist_summer_hr.png"))
knitr::include_graphics(c(
  "./A_Results/Model02_SSMU/obs_freq_dist_summer_biomass.png",
  "./A_Results/Model02_SSMU/obs_freq_dist_summer_hr.png"))
```

Figure S2. Frequency distribution of summer krill biomass, LKB (left), and summer harvest rate, LHR (right). Watter's model imputed (top; blue) and observed (middle; red) data, and Model SSMU (this paper; bottom; green), separated by SAM phase and gSSMU.
...
knitr::include_graphics(c(
  "./A_Results/Watters_model/Imputed/obs_freq_dist_bclass.png",
  "./A_Results/Watters_model/Imputed/obs_freq_dist_hrclass.png"))
knitr::include_graphics(c(
  "./A_Results/Model02_SSMU/obs_freq_dist_bclass.png",
  "./A_Results/Model02_SSMU/obs_freq_dist_hrclass.png"))
```

Figure S3. Frequency distribution of LKB categories (left) and LHR categories (right). Watter's model imputed (top; blue) and observed (middle; red) data, and model SSMU (this paper; bottom; green), separated by SAM phase and gSSMU.
...
kable(shapiro_results1, digits = 3, booktabs=TRUE,  
      col.names = c("gSSMU", 
             "SAM sign", 
              "n",
              "p", 
             "W"),
      longtable=TRUE, align="lcccc", caption = "Table S1. Shapiro--Wilk test results for normality of observed
log-transformed LKB values, reported by gSSMU and SAM sign. Columns show
sample size (n), p-value, and W-statistic.", escape=FALSE)
...
kable(shapiro_imp, digits = 3, booktabs=TRUE,  
      col.names = c("gSSMU", 
             "SAM sign", 
              "N total",
              "n sampled", 
             "W",
             "p"),
      longtable=TRUE, align="lccccc", caption = "Table S2. Shapiro--Wilk test results for normality of imputed
log-transformed LKB values. The table reports the total number of
imputations generated (N total), the subsample used for the test
(n sampled), and the corresponding W and p values for each gSSMU and SAM
sign.", escape=FALSE)
...
Figure S8. Posterior predictive distributions (boxplots) and jittered observations (colored circles) of penguin  76 performance. A) Watters model. B) Andy spatial. C) Andy SApatial, MArch = winter. D) Spatial and temporal SSMUs.
...
flextable(Table.05) |>
  ...
  autofit() |>
  set_caption("Table S5. Estimated whale abundance for gSSMU #1 and #2 during the study period.")
